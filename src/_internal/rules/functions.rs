                ...
                if let crate::_internal::analysis::facts::FuncOptionFact::Volatility(v) = opt {
                    match v {
                        crate::_internal::analysis::facts::VolatilityKind::Volatile => {
                            Some(crate::_internal::model::function::Volatility::Volatile)
                        }
                        crate::_internal::analysis::facts::VolatilityKind::Stable => {
                            Some(crate::_internal::model::function::Volatility::Stable)
                        }
                        crate::_internal::analysis::facts::VolatilityKind::Immutable => {
                            Some(crate::_internal::model::function::Volatility::Immutable)
                        }
                    }
                } else {
                    None
